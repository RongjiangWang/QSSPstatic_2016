...
c
      integer i,j,k,irr,nrr,nn
      double precision rr,drr,epsilon
      double precision yabs(6,3)
      double complex cdrr
      double complex y1(6,3),y2(6,3),yk(6,4),mat(6,6,3)
      save nn
c
...
c
      ...
      if(nn.lt.nrr)then
        nn=nrr
        write(*,'(a,i4,a,i3,a,i6)')' ruku: deg = ',ldeg,
     &                             ', layer = ',ly,', steps = ',nn
      endif
c
      nrr0=nrr
